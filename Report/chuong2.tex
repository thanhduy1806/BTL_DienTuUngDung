...
\hline
\end{tabular}
\caption{Thông số kỹ thuật loadcell YZC-133}
\label{tab:yzc133}   % để tham chiếu sau này bằng \ref{tab:yzc133}
\end{center}
\end{table}

Ta có: $\boxed{V_{out} = V_{in} \cdot V_{RO} \cdot \dfrac{m}{1kg}}$  với m là khối lượng đặt lên load cell.\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{image/OP07C.png}
    \caption{OPAMP OP07C}
    \label{fig:op07c}
\end{figure}
