...
Với khối lượng là 0kg, điện áp ngõ ra đo được là 650mV.
...
\hline
\end{tabular}
\caption{Ảnh hưởng nhiệt độ của Load cell}
\label{tab:loadcell_temp_effect}
\end{table}
...
\begin{figure}[H]
    ...
    \caption{Tổng quan thiết kế mạch nguyên lý đọc Load cell}
    \label{fig:overview}
\end{figure}
