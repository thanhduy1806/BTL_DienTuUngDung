...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{image/V_I_circuit_simu.png}
    \caption{Mô phỏng V-I converter}
    \label{fig:V_I_circuit_simu}
\end{figure}

\textbf{Nhận xét:} Với khối lượng là 1kg, dòng ngõ ra là 20mA đúng với tính toán.
Tuy nhiên để đạt được kết quả này cần phải điều chỉnh $V_{calib}$ bởi vì không có trở với giá trị $0.3125k \Omega$ so với lý thuyết nên nhóm chọn nối tiếp 3 điện trở 100$\Omega$ và 1 điện trở 10$\Omega$.
